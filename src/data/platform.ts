...
export const CITIES: City[] = [
  ...
  },
  {
    ...
    osm_place_name: "Hyderabad, Telangana, India",
    country: "India",
    region: "Telangana",
    evidence_state: "COMING_SOON",
    data_readiness: 0.14,
    caveat: "Road and POI extraction is planned; no verified predictions are published.",
    last_updated: "—",
  ...
  },
  {
    ...
    osm_place_name: "Chennai, Tamil Nadu, India",
    country: "India",
    region: "Tamil Nadu",
    evidence_state: "COMING_SOON",
    data_readiness: 0.12,
    caveat: "No compatible local labels or published scenario graph yet.",
    last_updated: "—",
  ...
  },
  {
    id: "kochi",
    display_name: "Kochi",
    osm_place_name: "Kochi, Kerala, India",
    country: "India",
    region: "Kerala",
    evidence_state: "COMING_SOON",
    data_readiness: 0.1,
    caveat: "No verified graph inference or affordability evidence is available.",
    last_updated: "—",
  ...
  },
  {
    id: "mumbai",
    display_name: "Mumbai",
    osm_place_name: "Mumbai, Maharashtra, India",
    country: "India",
    region: "Maharashtra",
    evidence_state: "COMING_SOON",
    data_readiness: 0.09,
    caveat: "City-scale extraction is on the roadmap; predictions are intentionally withheld.",
    last_updated: "—",
  ...
  },
  {
    ...
    osm_place_name: "Ahmedabad, Gujarat, India",
    country: "India",
    region: "Gujarat",
    evidence_state: "COMING_SOON",
    data_readiness: 0.07,
...
export const DATASETS: DatasetRecord[] = [
  ...
  v("mysuru", "roads", "OSM (osmnx)", "live extract", 55966),
  p(
    "mysuru",
    "food_pois",
    "OSM food POIs",
    "live extract",
    "Coverage is incomplete and tag-dependent",
  ),
  p("mysuru", "groceries", "OSM grocery tags", "live extract", "Used only as a proxy component"),
  p(
    "mysuru",
    "restaurants",
    "OSM only — no Zomato crawl",
    "2025-09",
    "Quality/diversity uses OSM category tags; affordability is unavailable",
  ),
  m("mysuru", "prices"),
  m("mysuru", "ratings"),
...
export const CHECKPOINTS_V2: ModelCheckpoint[] = [
  ...
  },
  {
    ...
    interpretation_note:
      "Operational checkpoint for Bengaluru hex-level decisions. Mysuru uses a separate matched OSM-only evaluation checkpoint.",
  },
];
...
export const RUNS: ModelRun[] = [
  ...
  },
  {
    id: "run_mys_002",
    city_id: "mysuru",
    checkpoint_id: "none_osm_proxy_v1",
